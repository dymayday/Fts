#############################################################################
# Makefile for building: fts
# Generated by qmake (2.01a) (Qt 4.8.2) on: lun. août 20 17:07:11 2012
# Project:  fts.pro
# Template: app
# Command: /usr/bin/qmake -spec /usr/share/qt/mkspecs/linux-g++ -o Makefile fts.pro
#############################################################################
...
Makefile: fts.pro  /usr/share/qt/mkspecs/linux-g++/qmake.conf /usr/share/qt/mkspecs/common/unix.conf \
		/usr/share/qt/mkspecs/common/linux.conf \
		/usr/share/qt/mkspecs/common/gcc-base.conf \
		/usr/share/qt/mkspecs/common/gcc-base-unix.conf \
		/usr/share/qt/mkspecs/common/g++-base.conf \
		...
		/usr/share/qt/mkspecs/features/lex.prf \
		/usr/share/qt/mkspecs/features/include_source_dir.prf
	$(QMAKE) -spec /usr/share/qt/mkspecs/linux-g++ -o Makefile fts.pro
...
dist: 
	@$(CHK_DIR_EXISTS) .tmp/fts1.0.0 || $(MKDIR) .tmp/fts1.0.0 
	$(COPY_FILE) --parents $(SOURCES) $(DIST) .tmp/fts1.0.0/ && (cd `dirname .tmp/fts1.0.0` && $(TAR) fts1.0.0.tar fts1.0.0 && $(COMPRESS) fts1.0.0.tar) && $(MOVE) `dirname .tmp/fts1.0.0`/fts1.0.0.tar.gz . && $(DEL_FILE) -r .tmp/fts1.0.0
...
fts.o: fts.cpp chronometer.hpp \
		neighbour.h
	$(CXX) -c $(CXXFLAGS) $(INCPATH) -o fts.o fts.cpp
